 ...
 */
void print_digit(int number) { printf("The magic number is %d.\n", number);}
 ...
 */
void format_str(char *buffer, unsigned int d, char *name, char initial) { sprintf(buffer, "Mister %s %c. has %d eggs", name, initial, d); }


int main()
{
    float PI = 3.1415926;
    printf("pi = %.4f", PI); // Prints "pi = 3.1416"
